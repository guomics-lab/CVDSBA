...
boxplot
```{r}
prot2 <- c("P01011","Q9UK55","P02741","Q86UD1","P13796","P0DJI8","P0DJI9")
label <- info$Type[match(names(df2),info$TMT)]
...
for (i in 1:nrow(df.nor)) {
  ...
  for (a in lav) {
    for (b in lav) {
        ...
        pv <- paste0(pv,paste0("  ",a,"_",b,":",format(c,digits = 3, scientific = FALSE)))
      
    }
  }
  ge.plot.boxplot( data1,data1$type,data1$value,data1$type,paste0("prot7_boxplot/",nm, "_boxplot"),title=paste0(nm, pv))
}
